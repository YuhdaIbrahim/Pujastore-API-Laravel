                                ...
                                <tbody>
                                    @forelse ($items as $item)
                                        <tr>
                                            ...
                                            <td>
                                                @if ($item->transaction_status == 'PENDING')
                                                    <a href="{{ route('transactions.status', $item->id) }}?status=SUCCESS" class="btn btn-sm btn-success"><i class="fa fa-check"></i></a>
                                                    <a href="{{ route('transactions.status', $item->id) }}?status=FAILED" class="btn btn-sm btn-danger"><i class="fa fa-times"></i></a>
                                                @endif
                                    ...
                                    @empty
                                        <tr>
                                           <td colspan="6" class="text-center p5">Empty Data !</td>
                                        </tr>
